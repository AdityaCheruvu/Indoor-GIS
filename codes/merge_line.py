...
def is_parallel(geom1, geom2):
    ...
    s1 = (points1[0][1] - points1[1][1]) / (points1[0][0] - points1[1][0])
...
def is_wall_lines(geom1, id1, geom2, id2, no_common_ending_check):
    if min_wall_width <= geom1.Distance(geom2) <= max_wall_width:
