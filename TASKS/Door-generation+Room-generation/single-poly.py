...
def main():
    ...
    for i in range(1, wall_layer.GetFeatureCount()):
        for j in range(0, wall_layer.GetFeatureCount()):
            ...
            print arr
            if (arr[0][0] == arr[1][0]) and (arr[0][1] == arr[1][1]) or (arr2[0][0] == arr2[1][0]) and (
                arr2[0][1] == arr2[1][1]):
                print "points"
            else:
                print "line"
                if (-0.01 < (arr[0][0] - arr2[0][0]) < 0.01) or (-0.01 < (arr[0][0] - arr2[1][0]) < 0.01) or (
                        -0.01 < (arr[1][0] - arr2[0][0]) < 0.01) or (-0.01 < (arr[1][0] - arr2[1][0]) < 0.01):
                    print "yes"
